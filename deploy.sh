...
gcloud projects add-iam-policy-binding $1 --member=serviceAccount:frame-stage@frame-customer-iaas-stage.iam.gserviceaccount.com --role=roles/iam.serviceAccountUser
